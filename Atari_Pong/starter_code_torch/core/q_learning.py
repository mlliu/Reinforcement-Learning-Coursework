...
class QN(object):
    ...
    def train(self, exp_schedule, lr_schedule):
        ...
        replay_buffer = ReplayBuffer(self.config.buffer_size, self.config.state_history)#state_history 4
        rewards = deque(maxlen=self.config.num_episodes_test) #50
        ...
        while t < self.config.nsteps_train:
            ...
            while True:
                ...
                #print("action,reward,new state is: " ,action,reward,new_state)
        ...
        #export_plot([1,2,3], "Scores", self.config.plot_output)
    ...
    def evaluate(self, env=None, num_episodes=None):
        ...
        for i in range(num_episodes):
            ...
            while True:
                ...
                #print("state,action,reward,new_state,done:",action,reward)
